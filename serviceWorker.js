importScripts("/CurrencyExchange/precache-manifest.103ad9cd982b1342cd336f7722135fb3.js", "https://storage.googleapis.com/workbox-cdn/releases/4.3.1/workbox-sw.js");
...
registerRoute(
  ...
  //a network request and the response will be cached so that the next
  //request is served directly from the cache.
  new CacheFirst( {
